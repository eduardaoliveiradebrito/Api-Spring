...
public class EstadoController {
	...
	public String getEstadosCSV(){
		final String SAMPLE_CSV_FILE = "/var/www/Api-Spring/estado/src/sample.csv";
		...
		return  "Confira a pasta /var/www/Api-Spring/estado/src/";
	}
	...
	public ArrayList<String> getCSV(){
		final String SAMPLE_CSV_FILE_PATH = "/var/www/Api-Spring/estado/src/Retorno_VGX_20220322.csv";
